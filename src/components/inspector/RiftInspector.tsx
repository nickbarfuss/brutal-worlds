...
import { Rift, ActiveDisasterMarker, Enclave } from '@/types/game';
...
const RiftInspector: React.FC<RiftInspectorProps> = ({ entity, activeDisasterMarkers, enclaveData, onPointerMove, onPointerLeave }) => {
